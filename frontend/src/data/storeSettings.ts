 ...
 * Unverified fields are placeholders and must not be treated as live NAP.
 */
export const storeSettings: StoreSettings = {
  name: 'Ishaq Medical, Surgical & Cosmetics',
  shortName: 'Ishaq Medicos',
  ...
  seo: {
    ...
    description:
      'Medical store in Gilgit-Baltistan for medicines, surgical and medical equipment, and cosmetics. Shop locally, upload a prescription, or enquire on WhatsApp.',
    indexable: true,
  },
};
